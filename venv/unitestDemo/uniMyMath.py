...
import time
import unittest
from unitestDemo.myMath import myMath1
...
if __name__ == '__main__':
    ...
    # #追加单个测试用例到测试集合中
    # #格式：类名(方法名)
    # suite.addTest(uniMyMath("testadd_1"))

    # #追加多个测试用例到测试集合中
    # suite.addTests(map(uniMyMath,["testadd_1","testadd_2"]))
    ...
    # #添加测试用例到测试集合中
    # suite = loader.loadTestsFromName("uniMyMath.uniMyMath.testadd_2")
